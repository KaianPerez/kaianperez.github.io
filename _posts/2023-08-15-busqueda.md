---
title:      "Busqueda"
excerpt:    "En esta ocasión tenemos otra máquina easy de Hack The Box, donde conseguiremos una reverse shell inicial que nos servirá para obtener información adicional y posteriormenteaprovecharnos de una vulnerabilidad en un script para ganar privilegios."
toc:        true
...
En esta ocasión volvemos con otra máquina easy de Hack The Box, donde conseguiremos una reverse shell inicial que nos servirá para obtener información adicional y posteriormente aprovecharnos de una vulnerabilidad en un script para ganar privilegios.
