...
Tras terminar la máquina, aunque no me hizo falta par la resolución, vamos a tratar de explicar el porqué de esa escalada a root. Me voy a traer el binario a la máquina atacante para examinarlo, por lo que creo un servidor Python `python3 -m http.server` desde "/bin" y lo descargo:
